public class L6{
    public static void main(String[] args){
       ...
       //powerScore1 = Math.pow(value1, value2); //throws an error
        ...
        // Math.max(double a, double b) = returns the highest of two values as their date type
        // Math.min(double a, double b) = returns the lowest of two values as their date type
